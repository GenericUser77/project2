...
echo '<!-- Descriptions are autofilled because we aren't getting tested on our ability to fake a company. We're getting tested on our ability to code a webpage. -->';
echo '<section class="section">';
echo '<h2>About Jobs at WellTech</h2>';
echo '<p>';
echo 'WellTech has multiple different job positions with varying requirements and responsibilities. Each job listed will also have it's salary shown, and a reference number. The current positions we are looking for are:';
echo '</p>';
echo '<ol>';
...
echo '<div class="logo">';
echo '<img src="styles/images/WellTech_Logo.PNG" alt="WellTech Logo">';
echo '<span>WellTech</span>';
echo '</div>';
echo '<!-- Navigation links -->';
echo '<ul class="nav-links">';
echo '<li><a href="index.html">Home</a></li>';
echo '<li><a href="about.html">About</a></li>';
echo '<li><a href="jobs.html">Job Description</a></li>';
...
echo '<span class="footer-brand">BestWebDevsInTown</span>';
echo '<div class="footer-divider"></div>';
echo '<div class="footer-links">';
echo '<a href="https://aydenrao.atlassian.net/jira/core/projects/BG/board?cloudId=ce8f769f-9671-42e4-b406-1f25b0a991ca&filter=&groupBy=status">Jira</a>';
echo '<a href="https://github.com/Pannnss/Assignment-1">GitHub</a>';
echo '<a href="mailto:info@welltech.com">Email</a>';
echo '</div>';
echo '</div>';
echo '<span class="footer-copy">&copy; 2026</span>';
echo '</footer>';
echo '';
echo '</body>';
echo '</html>';
